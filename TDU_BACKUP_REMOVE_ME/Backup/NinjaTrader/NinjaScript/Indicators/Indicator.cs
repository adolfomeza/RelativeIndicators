...
// Type: NinjaTrader.NinjaScript.Indicators.Indicator
...
public class Indicator : IndicatorRenderBase
{
  ...
  private NinjaTrader.NinjaScript.Indicators.WisemanAlligator[] cacheWisemanAlligator;
  private NinjaTrader.NinjaScript.Indicators.WisemanAwesomeOscillator[] cacheWisemanAwesomeOscillator;
  private NinjaTrader.NinjaScript.Indicators.WisemanFractal[] cacheWisemanFractal;
  private NinjaTrader.NinjaScript.Indicators.OrderFlowCumulativeDelta[] cacheOrderFlowCumulativeDelta;
  private NinjaTrader.NinjaScript.Indicators.OrderFlowMarketDepthMap[] cacheOrderFlowMarketDepthMap;
  private NinjaTrader.NinjaScript.Indicators.OrderFlowVWAP[] cacheOrderFlowVWAP;
  private NinjaTrader.NinjaScript.Indicators.OrderFlowTradeDetector[] cacheOrderFlowTradeDetector;
  private NinjaTrader.NinjaScript.Indicators.TDU.TDUPriceAction[] cacheTDUPriceAction;
  private NinjaTrader.NinjaScript.Indicators.Swing[] cacheSwing;
  private NinjaTrader.NinjaScript.Indicators.EMA[] cacheEMA;
  private NinjaTrader.NinjaScript.Indicators.ATR[] cacheATR;
  ...
  public NinjaTrader.NinjaScript.Indicators.WoodiesPivots WoodiesPivots(
    ...
    int width)
  {
    return this.WoodiesPivots(((NinjaScriptBase) this).Input, priorDayHlc, width);
  }
  ...
  {
    return this.WisemanAwesomeOscillator(((NinjaScriptBase) this).Input);
  }
  ...
  public NinjaTrader.NinjaScript.Indicators.WisemanFractal WisemanFractal(
    ...
    int triangleOffset)
  {
    return this.WisemanFractal(((NinjaScriptBase) this).Input, strength, triangleOffset);
  }
  ...
  public NinjaTrader.NinjaScript.Indicators.Swing Swing(int strength)
  {
    return this.Swing(((NinjaScriptBase) this).Input, strength);
  }

  [MethodImpl(MethodImplOptions.NoInlining)]
  public NinjaTrader.NinjaScript.Indicators.Swing Swing(ISeries<double> input, int strength)
  {
    return (NinjaTrader.NinjaScript.Indicators.Swing) null;
  }

  public NinjaTrader.NinjaScript.Indicators.EMA EMA(int period)
  {
    return this.EMA(((NinjaScriptBase) this).Input, period);
  }

  [MethodImpl(MethodImplOptions.NoInlining)]
  public NinjaTrader.NinjaScript.Indicators.EMA EMA(ISeries<double> input, int period)
  {
    return (NinjaTrader.NinjaScript.Indicators.EMA) null;
  }

  public NinjaTrader.NinjaScript.Indicators.ATR ATR(int period)
  {
    return this.ATR(((NinjaScriptBase) this).Input, period);
  }

  [MethodImpl(MethodImplOptions.NoInlining)]
  public NinjaTrader.NinjaScript.Indicators.ATR ATR(ISeries<double> input, int period)
  {
    return (NinjaTrader.NinjaScript.Indicators.ATR) null;
  }
